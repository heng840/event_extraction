...
def train(model, iterator, optimizer, criterion, loss):
    model.train()
...
if __name__ == "__main__":
    ...
    for epoch in range(1, hp.n_epochs + 1):
        train(model, train_iter, optimizer, criterion,train_loss)
        ...
        if train_loss <= min_loss_val:
            min_loss_val = train_loss
